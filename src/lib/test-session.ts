...
export class TestSession {
  ...
  getState() {
    return {
      ...
      currentSessionId: this.items.length ? (this.items[0].id ? this.items[0].id.split('-')[0] : null) : null // simplified ID logic or keep it managed externally
    };
  }
